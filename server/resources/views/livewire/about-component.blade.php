            ...
            <div class="container pt-25">
                <div class="row">
                    <div class="col-lg-6 align-self-center mb-lg-0 mb-4">
                        <h6 class="mt-0 mb-15 text-uppercase font-sm text-brand wow fadeIn animated">My Group</h6>
                        <h1 class="font-heading mb-40">
                            We are Building The Destination For Getting Things Done
                        </h1>
                        <p>We have overcome difficulties and challenges together to create the most complete product.</p>
                        <p>Technology: HTML, CSS, Bootstrap, PHP Laravel, MySql, GitHub.</p>
                        <p>Tools: XAMPP, VSCode, Jitst Meet, Google Document</p>
            ...
            <div class="container pt-25">
                <div class="row mb-50">
                    <div class="col-lg-12 col-md-12 text-center">
                        <h6 class="mt-0 mb-10 text-uppercase  text-brand font-sm wow fadeIn animated">TCM CNM</h6>
                        <h2 class="mb-15 text-grey-1 wow fadeIn animated">MEMBER</h2>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            ...
                            <div class="pl-30">
                                ...
                                <p class="font-sm text-grey-5">Leader</p>
                                <p class="text-grey-3">MaSV: 2050531200309.<br>Position: Backend <br>Function: register, log in, forgot password, update account info, payment and document</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            ...
                            <div class="pl-30">
                                ...
                                <p class="font-sm text-grey-5">Member</p>
                                <p class="text-grey-3">MaSV: 2050531200340.<br>Position: Backend <br>CRUD : (product, category, genre, author and status Oder) and register by facebook
 </p>
                            </div>
                        </div>
                    </div>
